					...
					<div class="row">
						<div class="input-field col s10 offset-s1">
							<i class="material-icons prefix">account_circle</i> <input
								...
								required> <label for="icon_prefix">Name</label>
						</div>
						<div class="row">
							<div class="input-field col s10 offset-s1">
						...
						<div class="row">
							<div class="input-field col s10 offset-s1">
								<i class="material-icons prefix">import_contacts</i> <input
									name="regi_no" type="text" class="validate" id="regi_no"
									required> <label for="regi_no">Registration No.</label>
								<span class="helper-text" data-error="Enter Registration No."></span>
							</div>
						</div>
						<div class="row">
							<div class="input-field col s10 offset-s1">
						...
						<div class="row">
							<div class="col s11">
								<label for name="dor"> Date Of Registration </label> <input
									type="date" name="dor">
							</div>
						</div>
						...
						<div class="row">
							<div class="input-field col s10 offset-s1">
								<i class="material-icons prefix">phone</i> <input
									...
									required> <label for="icon_telephone">Telephone</label>
							</div>
						</div>
						<div class="row">
							<div class="input-field col s10 offset-s1">
